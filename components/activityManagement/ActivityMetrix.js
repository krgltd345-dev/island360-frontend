...
const activity = {
    ...
    "updated_date": "2026-01-19T09:29:23.044000",
...
export default function ActivityPerformanceMetrics() {
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            {reviews.slice(0, 5).map((review) => (
              <div key={review.id} className="flex items-start gap-3 pb-3 border-b last:border-b-0">
                ...
                <div className="flex-1">
                  <p className="text-sm text-slate-900">{review.review_text}</p>
                  <p className="text-xs text-slate-500 mt-1">by {review.reviewer_name}</p>
                </div>
              </div>
            ))}
          </div>
