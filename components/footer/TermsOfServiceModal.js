      ...
      <DialogContent className="max-w-3xl! max-h-screen md:max-h-[90vh] max-sm:px-0 overflow-y-auto">
        ...
        <main className="max-w-3xl mx-auto px-3 space-y-5">
          ...
          <section id="s1" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">1. Binding Agreement</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
              <p className='m-0'>These Terms of Service ("Terms") form a legally binding agreement between you ("User") and Island 360 LLC ("Company," "Island 360").</p>
              <p className="font-medium text-slate-700 m-0">By accessing or using the Platform, you:</p>
          ...
          <section id="s2" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">2. Marketplace Status</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
              <p className='m-0'>Island 360 is a <strong>neutral technology platform</strong>.</p>
              <p className="font-medium text-slate-700 m-0">Island 360:</p>
              <ul className="space-y-1.5 pl-2">
          ...
          <section id="s3" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">3. User Eligibility</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s4" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">4. Booking &amp; Payment Structure</h3>
            </div>
          ...
          <section id="s5" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">5. Assumption of Risk</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s6" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">6. Release of Liability</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s7" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">7. Limitation of Liability</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s8" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">8. User Indemnification</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s9" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">9. No Warranties</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s10" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">10. Dispute Resolution</h3>
            </div>
            <div className="px-4 py-1 space-y-5 text-sm leading-relaxed">
              <div>
          ...
          <section id="s11" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">11. Canadian Users</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s12" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">12. Force Majeure</h3>
            </div>
            <div className="px-4 py-1 space-y-3 text-sm leading-relaxed">
          ...
          <section id="s13" className="bg-white overflow-hidden">
            <div className="px-2">
              <h3 className="text-black font-semibold text-sm tracking-widest uppercase">13. Survival</h3>
            </div>
